...
<div class="navbar-nav flex-row order-md-last">
    ...
    <a href="<?= base_url('pegawai/fitur_lainnya/profile_pegawai.php') ?>" class="dropdown-item">Profile</a>
    <a href="<?= base_url('pegawai/fitur_lainnya/ubah_password_pegawai.php') ?>" class="dropdown-item">Ubah Password</a>
